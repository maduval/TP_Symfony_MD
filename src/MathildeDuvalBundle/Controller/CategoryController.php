...
class CategoryController extends Controller
{
    ...
    public function showAction($slug, $page)
    {
        ...
        return $this->render('MathildeDuvalBundle:Category:show.'.$format.'.twig', array(
            'category' => $category,
            'last_page' => $last_page,
            ...
            'feedId' => sha1($this->get('router')->generate('MathildeDuvalBundle_category', array('slug' =>  $category->getSlug(), '_format' => 'atom'), true)),
        ));
    }
